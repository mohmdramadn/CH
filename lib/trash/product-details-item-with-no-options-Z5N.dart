...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // productdetailsitemwithnooption (181:8530)
        width: double.infinity,
        height: 844*fem,
        ...
        child: Stack(
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 5*fem,
                      child: Image.asset(
                        'assets/trash/images/arrow-gV2.png',
                        width: 2*fem,
                        height: 5*fem,
                      ),
                    ),
                    ...
                    Container(
                      ...
                      height: 5*fem,
                      child: Image.asset(
                        'assets/trash/images/arrow-XJU.png',
                        width: 2*fem,
                        height: 5*fem,
                      ),
                    ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 8*fem,
                  child: Image.asset(
                    'assets/trash/images/scroll-icon-hfr.png',
                    width: 50*fem,
                    height: 8*fem,
                  ),
                ),
            ...
            Positioned(
              // autogroupu4yadWL (8D2kbAPj6RQJXhjN2VU4ya)
              left: 0*fem,
              top: 524*fem,
              child: Container(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            // phonecase1hPi (181:8549)
                            width: 38*fem,
                            height: 38*fem,
                            child: Image.asset(
                              'assets/trash/images/phone-case-1-bzk.png',
                              fit: BoxFit.cover,
                            ),
                          ),
                        ],
            ...
            Positioned(
              // autogroupsx3n8NY (8D2knQZzQNTTdSLuewsx3N)
              left: 0*fem,
              top: 706*fem,
              child: Container(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // autogrouppgx6kui (8D2mYPJiEfHtuRTB6EpgX6)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 79*fem,
                                        child: Image.asset(
                                          'assets/trash/images/-YWx.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                        // ellipse39cqS (181:8580)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 79*fem,
                                        child: Image.asset(
                                          'assets/trash/images/-Cap.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                        // ellipse39zqz (181:8576)
                                        margin: EdgeInsets.fromLTRB(33*fem, 0*fem, 34*fem, 0*fem),
                                        width: double.infinity,
                                        height: 15*fem,
                                        decoration: BoxDecoration (
                          ...
                          Container(
                            // autogroupanriwFS (8D2mNokLbtYPfwk9vfanRi)
                            width: 113*fem,
                            height: double.infinity,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.end,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 79*fem,
                                        child: Image.asset(
                                          'assets/trash/images/-b8Q.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                        // ellipse39BJC (181:8572)
                                        margin: EdgeInsets.fromLTRB(33*fem, 0*fem, 34*fem, 0*fem),
                                        width: double.infinity,
                                        height: 15*fem,
                                        decoration: BoxDecoration (
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // autogroup9jyeFYx (8D2m7yqi6D2t4TV5bp9jyE)
                          ...
                          Container(
                            // autogroupm1nlKBS (8D2m19hkpaauQbyKuCM1nL)
                            width: 91*fem,
                            height: double.infinity,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.end,
                    ...
                    Container(
                      // autogroupmxaldbS (8D2kAqkvERkyH9i6TcMXaL)
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            // frame70427n (181:8582)
                            width: 25.6*fem,
                            height: 22*fem,
                            child: Image.asset(
                              'assets/trash/images/frame-704-QFn.png',
                              width: 25.6*fem,
                              height: 22*fem,
                            ),
                          ),
            ...
            Positioned(
              // autogroup7oxrY68 (8D2kNavMF8WDwMzbdL7oXr)
              left: 0*fem,
              top: 1079*fem,
              child: Container(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      // autogroup2zzguKz (8D2qZmbqNT8fQE8Mpr2zzG)
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height: 10*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-HkY.png',
                                  width: 18*fem,
                                  height: 10*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 10.97*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-ZUG.png',
                                  width: 15.27*fem,
                                  height: 10.97*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 13*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-aNp.png',
                                  width: 26.98*fem,
                                  height: 13*fem,
                                ),
                              ),
                      ...
                      Positioned(
                        // autogroupokygCJQ (8D2rLuyHBAaeyzUCBkoKYg)
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: 14.01*fem,
                                child: Image.asset(
                                  'assets/trash/images/share-1-iu2.png',
                                  width: 17.1*fem,
                                  height: 14.01*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 16*fem,
                                child: Image.asset(
                                  'assets/trash/images/cart-8sE.png',
                                  width: 14.58*fem,
                                  height: 16*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 15*fem,
                                child: Image.asset(
                                  'assets/trash/images/search-GF6.png',
                                  width: 15*fem,
                                  height: 15*fem,
                                ),
                              ),
                              ...
                              Container(
                                ...
                                height: 16*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-rX6.png',
                                  width: 8*fem,
                                  height: 16*fem,
                                ),
                              ),
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        // autogroupkswperY (8D2roEYkrAzNUTBHuhKSWp)
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              // autogroupxbjjxsE (8D2rtQ4pSd8hG3nX9RxBjJ)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11*fem, 0*fem),
                              width: 42*fem,
                              height: 40*fem,
                              child: Image.asset(
                                'assets/trash/images/auto-group-xbjj.png',
                                width: 42*fem,
                                height: 40*fem,
                              ),
                            ),
                            Container(
                              // autogroupj9g8HPi (8D2rwjJbnyjzzZba5CJ9g8)
                              width: 307*fem,
                              height: double.infinity,
                              decoration: BoxDecoration (

...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // productdetailsoutofstocki1a (151:7589)
        width: double.infinity,
        height: 844*fem,
        ...
        child: Stack(
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 5*fem,
                      child: Image.asset(
                        'assets/trash/images/arrow-iFE.png',
                        width: 2*fem,
                        height: 5*fem,
                      ),
                    ),
                    ...
                    Container(
                      ...
                      height: 5*fem,
                      child: Image.asset(
                        'assets/trash/images/arrow-3Pz.png',
                        width: 2*fem,
                        height: 5*fem,
                      ),
                    ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 8*fem,
                  child: Image.asset(
                    'assets/trash/images/scroll-icon-2uA.png',
                    width: 50*fem,
                    height: 8*fem,
                  ),
                ),
            ...
            Positioned(
              // autogroupjeviJpL (8Cw1v8skTs5Wq1oj4njEVi)
              left: 0*fem,
              top: 524*fem,
              child: Container(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            // phonecase1qBz (151:7608)
                            width: 38*fem,
                            height: 38*fem,
                            child: Image.asset(
                              'assets/trash/images/phone-case-1-a9A.png',
                              fit: BoxFit.cover,
                            ),
                          ),
                        ],
            ...
            Positioned(
              // autogroupaiqtTsa (8Cw27JDpVMWzLLUSmhaiQt)
              left: 0*fem,
              top: 706*fem,
              child: Container(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // autogroupad3zswJ (8Cw2ucDzGVaYDt3r4EAd3z)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 79*fem,
                                        child: Image.asset(
                                          'assets/trash/images/-dJL.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                        // ellipse39zuS (151:7639)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 79*fem,
                                        child: Image.asset(
                                          'assets/trash/images/-S4C.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                        // ellipse39mYp (151:7635)
                                        margin: EdgeInsets.fromLTRB(33*fem, 0*fem, 34*fem, 0*fem),
                                        width: double.infinity,
                                        height: 15*fem,
                                        decoration: BoxDecoration (
                          ...
                          Container(
                            // autogroupjibvVji (8Cw2mH8Xtc4GtbXDjpJiBv)
                            width: 113*fem,
                            height: double.infinity,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.end,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 79*fem,
                                        child: Image.asset(
                                          'assets/trash/images/-wKa.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                        // ellipse39Pic (151:7631)
                                        margin: EdgeInsets.fromLTRB(33*fem, 0*fem, 34*fem, 0*fem),
                                        width: double.infinity,
                                        height: 15*fem,
                                        decoration: BoxDecoration (
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            // autogroupztyaSRz (8Cw2TndgJErvHu1hsYztya)
                          ...
                          Container(
                            // autogroupjy5v8CL (8Cw2M8A7bXeJpsPc22Jy5v)
                            width: 91*fem,
                            height: double.infinity,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.end,
                    ...
                    Container(
                      // autogroupjvpi3yW (8Cw1VyuLAnfYmHg7LzjVPi)
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            // frame704Qha (151:7641)
                            width: 25.6*fem,
                            height: 22*fem,
                            child: Image.asset(
                              'assets/trash/images/frame-704-oRv.png',
                              width: 25.6*fem,
                              height: 22*fem,
                            ),
                          ),
            ...
            Positioned(
              // autogroupub1eLbE (8Cw1gyb1dMsf5nTBCpUB1e)
              left: 0*fem,
              top: 1079*fem,
              child: Container(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      // autogroupynuatWG (8Cw6rAKpwfjiJju7FGynuA)
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height: 10*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-s88.png',
                                  width: 18*fem,
                                  height: 10*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 10.97*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-eUL.png',
                                  width: 15.27*fem,
                                  height: 10.97*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 13*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-VQg.png',
                                  width: 26.98*fem,
                                  height: 13*fem,
                                ),
                              ),
                      ...
                      Positioned(
                        // autogrouplxtgoqW (8Cw7bJkbwNRKebZ7T8LXtg)
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: 14.01*fem,
                                child: Image.asset(
                                  'assets/trash/images/share-1-BXA.png',
                                  width: 17.1*fem,
                                  height: 14.01*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 16*fem,
                                child: Image.asset(
                                  'assets/trash/images/cart-RfS.png',
                                  width: 14.58*fem,
                                  height: 16*fem,
                                ),
                              ),
                              Container(
                                ...
                                height: 15*fem,
                                child: Image.asset(
                                  'assets/trash/images/search-J8c.png',
                                  width: 15*fem,
                                  height: 15*fem,
                                ),
                              ),
                              ...
                              Container(
                                ...
                                height: 16*fem,
                                child: Image.asset(
                                  'assets/trash/images/group-CVr.png',
                                  width: 8*fem,
                                  height: 16*fem,
                                ),
                              ),
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        // autogroupo3ekbgp (8Cw84xdC9ifxdfPRwmo3Ek)
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              // autogroupcbrkKcp (8Cw89npUcLMZ3cDMVLCBrk)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11*fem, 0*fem),
                              width: 42*fem,
                              height: 40*fem,
                              child: Image.asset(
                                'assets/trash/images/auto-group-cbrk.png',
                                width: 42*fem,
                                height: 40*fem,
                              ),
                            ),
                            Container(
                              // autogroupex6pqbA (8Cw8DHieXcCDxwv4GBex6p)
                              width: 307*fem,
                              height: double.infinity,
                              decoration: BoxDecoration (

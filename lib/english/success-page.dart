          ...
          children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              height: 10*fem,
                              child: Image.asset(
                                'assets/english/images/group-QzQ.png',
                                width: 18*fem,
                                height: 10*fem,
                              ),
                            ),
                            Container(
                              ...
                              height: 10.97*fem,
                              child: Image.asset(
                                'assets/english/images/group-kAg.png',
                                width: 15.27*fem,
                                height: 10.97*fem,
                              ),
                            ),
                            Container(
                              ...
                              height: 13*fem,
                              child: Image.asset(
                                'assets/english/images/group-ipk.png',
                                width: 26.98*fem,
                                height: 13*fem,
                              ),
                            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // group713dyN (226:3889)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.65*fem, 18.5*fem),
                    width: 115.35*fem,
                    height: 99*fem,
                    child: Image.asset(
                      'assets/english/images/group-713.png',
                      width: 115.35*fem,
                      height: 99*fem,
                    ),
                  ),
                  Center(
                    // thankyoukHJ (226:3893)
                    child: Container(
                  ...
                  Center(
                    // theorderconfirmationhasbeensen (226:3894)
                    child: Container(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          // paymentmethodcashondeliverysic (226:3899)
                          child: RichText(
                            textAlign: TextAlign.center,
                            text: TextSpan(
                              style: SafeGoogleFont (
                  ...
                  Container(
                    // pleaserememberifyoudonotfindyo (226:3903)
